...
const onSubmit= async (e) => {
  ...
  return (
    <div className="py-10">
  <div className="h-[500px] xl:h-[500px] 2xl:h-[530px] relative overflow-hidden">
    ...
    <div className='h-64 z-10 relative flex '>
      ...
      <div className="  w-80 xl:w-[430px] xl:h-[900px] sm:w-72 2xl:w-[450px] h-fit 2xl:h-[800px] bg-gray-100 rounded-md ">
        ...
        <div className=" px-7 xl:px-3 py-10 sm:py-5 2xl:py-10 space-y-4 ovrflow-visible">
          <input required onChange={(e)=>{setName(e.target.value)}} className='border-2 text-sm xl:text-2xl 2xl:text-2xl p-2 xl:p-4 2xl:p-3 w-full' type="text" placeholder='Your Name' name="" id="" />
          <input required onChange={(e)=>{setEmail(e.target.value)}} className=' border-2 text-sm xl:text-2xl 2xl:text-2xl p-2 xl:p-4 2xl:p-3 w-full ' type="text" placeholder='Email' name="" id="" />
          <input required onChange={(e)=>{setContactNo(e.target.value)}} className='border-2 text-sm xl:text-2xl 2xl:text-2xl p-2 xl:p-4 2xl:p-3 w-full ' type="text" placeholder='Mobile' name="" id="" />
        </div>
        <button className="my-2 px-3 py-2 xl:p-3 xl:px-6 2xl:py-4 2xl:px-8  bg-[#FCAA2D] rounded-md text-sm xl:text-lg 2xl:text-xl text-white">Get it Now</button>
      </div>
      </form>
      </div>
