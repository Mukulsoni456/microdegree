  ...
  return (
    ...
    <div className='w-full pb-10 flex justify-center items-center flex-wrap sm:space-x-14 space-y-7 '>
      ...
      <div className=" w-full flex items-center justify-center ">
        ...
        <h3 className="text-3xl font-medium text-gray-800 font-roboto text-left">How we execute</h3>
        <div className="w-full font-roboto text-gray-700  space-y-4 ">
          <div className=" w-full flex justify-between  items-center  ">
            <p>1.</p>
            <PencilAltIcon className='w-5  '></PencilAltIcon>
            <div className="text-left font-roboto "><h5 className='font-medium'>Explore Course</h5>
            <p className='text-[0.6rem] text-gray-500'>This is first step you should take to join</p></div>
          </div>
          <div className=" w-full flex justify-between items-center">
            <p>2.</p>
            <PencilAltIcon className='w-5 '></PencilAltIcon>
            <div className="text-left"><h5 className='font-medium'>Choose Class</h5>
            <p className='text-[0.6rem] text-gray-500'>This is 2nd step you should take to join</p></div>
          </div>
          <div className=" w-full flex justify-between items-center">
            <p>3.</p>
            <PencilAltIcon className='w-5 '></PencilAltIcon>
            <div className="text-left"><h5 className='font-medium' >Enroll First</h5>
            <p className='text-[0.6rem] text-gray-500'>This is 3rd step you should take to join</p></div>
          </div>
          <div className=" w-full flex justify-between items-center ">
            <p>4.</p>
              <PencilAltIcon className='w-5 '></PencilAltIcon>
            <div className="text-left"><h5 className='font-medium' >Start Learning</h5>
            <p className='text-[0.6rem] text-gray-500'>This is 4th step you should take to join</p></div>
          </div>
        </div>
