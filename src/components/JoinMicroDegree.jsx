...
function HomeSection4() {
  return (
    ...
    <div className='w-full pb-10 py-24 px-5 flex justify-center 2xl:justify-around 2xl:px-44  items-center flex-wrap sm:space-x-14 space-y-7 '>
      <h1 className=" h-full text-4xl xl:text-5xl xl:max-w-xl 2xl:text-5xl 2xl:max-w-xl text-gray-700 font-[600]  max-w-md text-left">How to join Million <br/> course from <span className='text-[#FB4474]'>MicroDegree</span> </h1>
      ...
      <div className=" w-full flex items-center justify-center ">
        <img className='hidden sm:block w-2/5 xl:w-1/2 ' src={section4Img} alt="" />
