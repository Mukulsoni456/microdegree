...
<div className=' w-full  sm:basis-1/2 flex-none '>
  <div className="  relative w-full px-5 h-[450px] 2xl:h-[550px]">
...
<div className="w-72 2xl:w-[350px] h-full absolute right-4 top-4 z-10  ">
  ...
  <img className="object-fit absolute" src={rectangle40} alt="" />
    ...
    <form onSubmit={onSubmit} action='' className=" absolute flex flex-col justify-center w-full h-full p-10 space-y-3  z-20">

      <input required onChange={(e)=>{setName(e.target.value)}} className='w-full text-sm 2xl:text-base text-gray-700 p-2 px-2 rounded outline-none bg-[rgba(255,255,255,0.85)]' type="text" name="" placeholder="Your name" id="" />
      <input required onChange={(e)=>{setContactNo(e.target.value)}} className='w-full text-sm 2xl:text-base text-gray-700 p-2 px-2 rounded outline-none bg-[rgba(255,255,255,0.85)]' type="number" name="" placeholder="Mobile No" id="" />
      <input required onChange={(e)=>{setEmail(e.target.value)}} className='w-full text-sm 2xl:text-base text-gray-700 p-2 px-2 rounded outline-none bg-[rgba(255,255,255,0.85)]' type="email" name="" placeholder="Email" id="" />
...
<div className='flex items-center space-x-3'><div className='bg-[#FF0049]   p-[0.15rem] h-[0.2rem] w-[0.2rem] rounded-xl'></div> <div className='bg-[#FF0049] p-[0.15rem]   w-[0.1rem] rounded-xl'></div> <p className='uppercase font-bold text-gray-400 tracking-widest text-xs '>Learn New Skills</p> <div className='bg-[#FF0049]  p-[0.15rem] h-[0.2rem] w-[0.2rem] rounded-xl'></div> <div className='bg-[#FF0049]  p-[0.15rem] h-[0.2rem] w-[0.2rem] rounded-xl'></div> </div>
  ...
  <h1 className=" text-5xl 2xl:text-6xl text-gray-800 ">Multilingual <br /> <span className="font-bold">IT Skilling</span> Platform <br />for <span className="font-bold"> Bharat</span> </h1>
  <p className='text-gray-800 text-sm 2xl:text-base'>Platform where you Learn the most In-demand IT Skills that are currently booming and increase your chance of landing a high paying job.</p>
  <ul className=" w-full text-sm 2xl:text-base text-gray-800">
