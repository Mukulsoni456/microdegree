...
function Section8Card({ vidSrc, bottomImg, course_name, name}) {
  return (
<div className={` group rounded-md relative shadow-lg min-w-[300px] hover:min-w-[350px] 2xl:min-w-[400px] 2xl:hover:min-w-[550px] duration-400 transition-all ease-in-out h-fit bg-white group`}>
...
<img className='absolute top-0 group-hover:hidden ' src={imgOverlay} alt="" />
<img className='absolute  w-12 top-24 left-32 2xl:top-28 2xl:left-44 group-hover:hidden' src={playIcon} alt="" />
