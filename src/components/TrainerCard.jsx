...
function Section6Card({title, desc, top_logo, bottom_logo, profession, cardColor, propColor}) {
  ...
  return (
<div className={`relative min-w-[250px] xl:min-w-[320px] xl:h-fit 2xl:min-w-[340px]  space-y-4 2xl:space-y-3 flex flex-col justify-center   ${cardColor} rounded-lg overflow-hidden shadow-lg p-5 2xl:p-10 space-y-3 2xl:space-y-4`}>
