...
function CourseCard({cardImg, title, category, price, courseLink, desc }) {
  return (
<div className=" m-auto sm:m-0 w-60 min-h-[350px] h-[350px] rounded overflow-hidden shadow-lg">
  <a href={courseLink}>
  ...
  <div className="px-4 py-3 h-full  bg-white text-left space-y-2">
    ...
    <p className="text-gray-700 text-xs trumcat">{desc}
    </p>
  </div>
  </a>
</div>
