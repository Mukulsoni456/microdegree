...
//   #function starts from here    
  ...
  return (
    ...
    <div className=" w-full flex justify-between items-center ">
      ...
      <button onClick={()=>setStatus('live')} className={` 2xl:text-base hover:bg-[#FF0049] ${status.includes('live')?"bg-[#FF0049] text-white":"bg-gray-300"} hover:text-white px-3 py-2 rounded-sm text-sm`}>Live</button>
      <button onClick={()=>setStatus('hybrid')} className={` 2xl:text-base hover:bg-[#FF0049] ${status.includes('hybrid')?"bg-[#FF0049] text-white":"bg-gray-300"} hover:text-white px-3 py-2 rounded-sm text-sm`} >Hybrid</button>
      <button onClick={()=>setStatus('pre recorded')} className={` 2xl:text-base hover:bg-[#FF0049] ${status.includes('pre recorded')?"bg-[#FF0049] text-white":"bg-gray-300"} hover:text-white px-3 py-2 rounded-sm text-sm`} >Pre Recorded</button>
      </div>
    ...
    <div className="px-5 flex  items-center w-full h-full  md:space-x-8 flex-wrap sm:flex-nowrap md:space-y-0 space-y-14 overflow-x-scroll scrollbar-hide ">
