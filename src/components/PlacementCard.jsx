...
<div className=" h-80   mb-8 mx-auto relative w-[280px]  sm:w-60 2xl:w-[300px]  rounded overflow-hidden shadow-lg">
  ...
  <img className="w-full h-full object-cover p-2" src={cardImg} alt="Sunset in the mountains"/>
  </div>
  <div className="px-4 py-3 h-full bg-gray-100 text-center space-y-2">
    <h1 className="font-bold text-lg 2xl:text-2xl mb-2">{title}</h1>
    <p className="text-gray-700 font-normal tracking-wider text-sm 2xl:text-base p-1">
        {desc}
    </p>
