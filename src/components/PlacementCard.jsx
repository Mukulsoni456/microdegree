...
function Section5Card({title, desc, cardImg, logoImg,  }) {
  return (
    <>
<div className=" h-[22rem] xl:h-96 2xl:h-[420px]  mb-8 mx-auto relative min-w-[280px] xl:min-w-[280px]  sm:w-60 2xl:min-w-[340px]  rounded-xl overflow-hidden shadow-lg">
