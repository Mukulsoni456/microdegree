...
function Modal({setViewModal, viewModal}) {
  ...
  return (
    ...
    <div className="absolute h-full w-full bg-gradient-to-br from-purple-600 to-blue-500 inset-0 -z-10"></div>
    <div className='relative w-full h-screen items-center justify-center flex p-3'>
 <div className="relative w-full flex flex-col max-w-[400px] shrink py-2 px-5  rounded-xl shadow-lg  bg-gray-900 ">
   ...
   <div onClick={()=>setViewModal(!viewModal)} className='absolute right-4 top-3'> <XIcon className='w-7 p-1 text-white hover:text-blue-500'></XIcon> </div>
   <div className="">
   <form onSubmit={onSubmit} action="" className=''>
     ...
     <div className='p-3 py-6 space-y-5'>
                ...
                <div className='w-full text-left'>
                    ...
                    <input onChange={(e)=>{setName(e.target.value)}} className='  text-[0.95rem] 2xl:text-lg outline-none border-gray-800 bg-transparent border-b-2 w-full' placeholder='Your Name' type="text" name="name" id="name" />
                </div>
                <div className='w-full text-left'>
                    <p className='text-sm 2xl:text-base text-gray-100'>Email</p>
                    <input onChange={(e)=>{setEmail(e.target.value)}} className='  text-[0.95rem] 2xl:text-lg outline-none border-gray-800 bg-transparent border-b-2 w-full' placeholder='Enter Your Email Address' type="email" name="email" id="email" />
                </div>
                <div className='w-full text-left'>
                    <p className='text-sm 2xl:text-base text-gray-100'>Mobile No</p>
                    <input onChange={(e)=>{setMobileNo(e.target.value)}} className=' text-[0.95rem] 2xl:text-lg outline-none border-gray-800 bg-transparent border-b-2 w-full' placeholder='Enter Your Mobile No' type="number" name="number" id="number" />
                </div>
     ...
     <div className="p-3  mt-2 text-center space-x-4 md:block">
         <button type='submit' className="mb-2 2xl:text-lg md:mb-0 bg-gradient-to-br from-purple-600 to-blue-500 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white w-full hover:shadow-lg ">Submit</button>
     </div>
     </form>
   </div>
   </div>
