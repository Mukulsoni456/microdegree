...
<div className="  space-y-10 text-left">
  ...
  <h1 className="text-4xl sm:text-5xl 2xl:text-6xl  sm:tracking-[0.06em] space-x-2 text-gray-800"><span className="font-bold text-gray-700">Placement</span> Diaries</h1>
